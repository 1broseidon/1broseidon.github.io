...
/* Sub-paths that used to be GitHub Pages sites under this domain. Their URLs
 * are in the wild, so they forward rather than 404. cymbal has graduated to its
 * own domain; the rest are dormant projects that now point at their source.
 * Cloudflare serves these natively from _redirects — no Worker script needed. */
